...
define('raemadeline/components/fade-in-image', ['exports', 'ember', 'raemadeline/config/environment'], function (exports, _ember, _raemadelineConfigEnvironment) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    imagePath: _ember['default'].computed('sourceImage', function () {
      if (_raemadelineConfigEnvironment['default'].environment === "production") {
        return '' + _raemadelineConfigEnvironment['default'].rootURL + this.get('sourceImage');
      }
    ...
    _setupImage: function _setupImage() {
      ...
      img.onload = function () {
        ...
        _this.$().css('background-image', 'url(' + _this.get('imagePath') + ')');
...
if (!runningTests) {
  require("raemadeline/app")["default"].create({"name":"raemadeline","version":"0.0.0+69346375"});
}
